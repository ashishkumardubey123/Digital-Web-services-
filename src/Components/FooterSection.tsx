        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                ...
                <div className="space-y-6">
                    ...
                    <p className="text-gray-400 leading-relaxed text-sm">
                        Transforming ideas into digital reality. We build high-performance websites and data-driven marketing strategies for modern businesses.
                    </p>
                    <div className="flex gap-4">
                        {[Instagram, Linkedin, Twitter, Facebook].map((Icon, i) => (
                            <a key={i} href="#" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-purple-600 hover:text-white transition-all duration-300">
                ...
                <div>
                    ...
                    <ul className="space-y-4">
                        {['Web Development', 'SEO Optimization', 'Social Media Marketing', , 'Content Strategy'].map((item) => (
                            <li key={item}>
                                <a href="#" className="flex items-center group hover:text-purple-400 transition-colors text-sm">
                ...
                <div>
                    ...
                    <ul className="space-y-4">
                        {["Home",'About Us', 'Services', 'Portfolio',].map((item) => (
                            <li key={item}>
                                <Link href="/" className="hover:text-purple-400 transition-colors text-sm">{item}</Link>
                            </li>
                        ))}
                    </ul>
                </div>
                    ...
                    <ul className="space-y-6">
                        <li className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <a href="mailto:ad201054@gmail.com" className="text-white hover:text-purple-400 transition-colors text-sm">ad201054@gmail.com</a>
                            </div>
                        </li>
                        <li className="flex items-start gap-4">
                            <div className="p-2 rounded-lg bg-gray-800 text-purple-400">
                            ...
                            <div>
                                ...
                                <a href="tel:+919302300834" className="text-white hover:text-purple-400 transition-colors text-sm">+91 9302300834</a>
                            </div>
                        </li>
                        <li className="flex items-start gap-4">
                            <div className="p-2 rounded-lg bg-gray-800 text-purple-400">
                            ...
                            <div>
                                ...
                                <span className="text-white text-sm">Online / Remote Agency</span>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                <p className="text-sm text-gray-500">
                    &copy; {new Date().getFullYear()} DigiWebx Agency. All rights reserved.
                </p>
